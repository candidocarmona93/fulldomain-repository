...
async function onSubChange(event, messaging) {
  ...
  const tokenDetails = await dbGet(messaging.firebaseDependencies);
  await deleteTokenInternal(messaging);
  messaging.vapidKey = ((_a = tokenDetails == null ? void 0 : tokenDetails.subscriptionOptions) == null ? void 0 : _a.vapidKey) ?? DEFAULT_VAPID_KEY;
...
function getLink(payload) {
  var _a, _b;
  const link = ((_a = payload.fcmOptions) == null ? void 0 : _a.link) ?? ((_b = payload.notification) == null ? void 0 : _b.click_action);
  if (link) {
    return link;
  }
