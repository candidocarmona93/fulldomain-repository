...
export class Row extends BaseWidget {
    ...
    createRowElement(children, rowStyle) {
        ...
        const isNonExpandChild = (childIntegrity.isNonExpandChild > 0 && childIntegrity.isExpandChild === 0);
        return [
            new BaseWidget({
                tagName: "div",
                ...
                style: {
                    ...rowStyle,
                    '--gutter-x': !isNonExpandChild ? this.gap : undefined,
                    gap: isNonExpandChild ? this.gap : undefined
                },
                children,
                onAttached: (el) => {
                    this.rowElement = el;
