...
import "../../styles/buttons/outlined-button-widget.css";

/**
 * @class OutlinedButton
 * @extends BaseWidget
 * @description A customizable outlined button widget with border and transparent background.
 */
export class OutlinedButton extends BaseWidget {
  /**
   * @constructor
   * @param {object} [options={}] - Configuration options for the OutlinedButton widget.
   * @param {string} [options.label="Outlined Button"] - The text displayed on the button.
  ...
  constructor({
    ...
    prefixIcon = null,
    suffixIcon = null,
    theme = Themes.outlinedButton.type.primary,
    size = Themes.outlinedButton.size.medium,
    fullWidth = false,
    type = "button",
    onPressed = null,
    style = {},
    ...
    if (typeof label !== "string") {
      throw new Error("label prop in OutlinedButton widget expects string");
    }
